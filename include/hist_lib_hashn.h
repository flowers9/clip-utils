...
extern bool add_sequence_mers(std::list<Read>::const_iterator, std::list<Read>::const_iterator, hashn &);
extern bool add_sequence_mers(std::list<Read>::const_iterator, std::list<Read>::const_iterator, hashn &, const std::map<std::string, hashn::offset_type> &);
